...
class AlexaApi {
  ...
  getAccountLinkings(vendorId) {
    return BbPromise.bind(this)
      ...
      .mapSeries(function (skill) {
        return this.get(`/skills/${skill.skillId}/stages/development/accountLinkingClient`).then(body => BbPromise.resolve({
          id: skill.skillId,
  ...
  updateAccountLinking(skillId, accountLinkingRequest) {
    ...
    return this.put(`/skills/${skillId}/stages/development/accountLinkingClient`, { accountLinkingRequest })
      .then(() => BbPromise.resolve({ id: skillId }));
  }
}
